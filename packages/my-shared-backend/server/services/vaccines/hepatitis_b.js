import { addDays, formatDate, getAgeInMonths } from '../vaccine-catchup';
export function hepatitisBRecommendation(normalizedName, birthDate, currentDate, validDoses, numDoses, sortedDoses, specialConditions, immunityEvidence) {
