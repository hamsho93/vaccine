import { getAgeInMonths, getAgeInYears } from '../vaccine-catchup';
export function influenzaRecommendation(normalizedName, birthDate, currentDate, validDoses, numDoses, sortedDoses, specialConditions, immunityEvidence) {
