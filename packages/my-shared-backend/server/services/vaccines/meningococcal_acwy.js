import { getAgeInYears, getAgeInDays, formatDate } from '../vaccine-catchup';
export function meningococcalACWYRecommendation(normalizedName, birthDate, currentDate, validDoses, numDoses, sortedDoses, specialConditions, immunityEvidence) {
    ...
    if (currentAgeYears >= 11 && currentAgeYears <= 12) {
        ...
        if (numDoses === 0) {
            ...
            const lastDoseAge = sortedDoses.length > 0 ?
                getAgeInYears(birthDate, sortedDoses[0].date) : 0;
