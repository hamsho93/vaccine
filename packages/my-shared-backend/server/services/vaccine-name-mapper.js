...
export class VaccineNameMapper {
    constructor() {
        this.nameToInternalMap = new Map();
        this.internalToDisplayMap = new Map();
        this.internalToStandardMap = new Map();
        this.internalToEntryMap = new Map();
        this.buildMaps();
    }
    static getInstance() {
    ...
    getAgeSpecificDisplay(internalCode, ageInYears) {
